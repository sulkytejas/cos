// Restored from the pre-v0.7 standalone Capture sheet so the legacy v0.3 UI
// (RootView, shown only when AtlasApp.showAyumi == false) keeps compiling after
// CaptureSheet was repurposed for the v0.7 co-completion well. Not used by the
// Ayumi v0.6/v0.7 shell.
import SwiftUI
import SwiftData

struct LegacyCaptureSheet: View {
